...
var (
	...
	ErrDirectoryCreate          = errors.New("directory creation failed")
	ErrDirectoryUpdate          = errors.New("directory update failed")
	ErrDirectoryDelete          = errors.New("directory delete failed")
	ErrDirectoryGet             = errors.New("directory get failed")
	ErrDirectoryVerify          = errors.New("directory verify failed")
	ErrDirectoryVerifyTimeout   = errors.New("directory verify timed out")
	ErrDirectorySearch          = errors.New("directory search failed")
	ErrDirectorySearchTimeout   = errors.New("directory search timed out")
